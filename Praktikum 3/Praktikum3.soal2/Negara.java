...
public class Negara {
    ...
    public Negara(String NamaNegara, String JenisKepemimpinan, String NamaPemimpin, int TanggalMerdeka, int BulanMerdeka, int TahunMerdeka){
        nama = NamaNegara;
        jenis = JenisKepemimpinan;
        pemimpin = NamaPemimpin;
